...
InfoItens<-read_xlsx(file.path(dados_dir,'gabarito_3serie_lp 4ª SIMULA.xlsx'),sheet = 'LP_3EM_S4')
...
write.xlsx(base,paste(result_dir,sep="/BaseRespTheta_3EM_LP_S4",".xlsx"),rowNames=T)
...
write.xlsx(freqTheta,paste(result_dir,sep="/DistriAlunosClasseLP3serie_S4",".xlsx"),rowNames=T)
...
write.xlsx(TabItens,paste(result_dir,sep="/EstItens_3EM_LP_S4",".xlsx"),rowNames=F)
...
write.xlsx(as.data.frame(med_resu),paste(result_dir,sep="/ResumoTheta_3EM_LP_S4",".xlsx"),rowNames=T)
...
write.xlsx(rbind(EstPop),paste(result_dir,sep="/ResumoThetaIC_3EM_LP_S4",".xlsx"),rowNames=T)
