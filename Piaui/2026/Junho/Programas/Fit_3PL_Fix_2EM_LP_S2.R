...
InfoItens<-read_xlsx(file.path(dados_dir,'gabarito_2serie_lp 2ª SIMULA.xlsx'),sheet = 'LP-SimII')
...
write.xlsx(base,paste(result_dir,sep="/BaseRespTheta_2EM_LP_S2",".xlsx"),rowNames=T)
...
write.xlsx(freqTheta,paste(result_dir,sep="/DistriAlunosClasseLP2serie_S2",".xlsx"),rowNames=T)
...
write.xlsx(TabItens,paste(result_dir,sep="/EstItens_2EM_LP_S2",".xlsx"),rowNames=F)
...
write.xlsx(as.data.frame(med_resu),paste(result_dir,sep="/ResumoTheta_2EM_LP_S2",".xlsx"),rowNames=T)
...
write.xlsx(rbind(EstPop),paste(result_dir,sep="/ResumoThetaIC_2EM_LP_S2",".xlsx"),rowNames=T)
