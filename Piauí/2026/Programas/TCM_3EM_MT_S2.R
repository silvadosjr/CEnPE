...
source(file.path('~/CEnPE/Piauí',"Aux Func IRT.r"))
...
#saveRDS(df_2ª_SIMULA_3ª_SÉRIE,here('Dados','df_2ª_SIMULA_3ª_SÉRIE.RDS'))
...
base <- readRDS(here('Dados','df_2ª_SIMULA_3ª_SÉRIE.RDS'))
